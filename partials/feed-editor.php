...
<script>
// Qdo clica no botão pega o que foi digitado /envia /e pega no formulario
...
feedSubmit.addEventListener('click', function(){
    let value = feedInput.innerText.trim();//Pega o txto digitado no input do pensando

    feedForm.querySelector('input[name=body]').value = value;//Coloca o digitado no corpo 
    feedForm.submit();
